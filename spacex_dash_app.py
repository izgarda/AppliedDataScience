...
def get_pie_chart(site_dropdown):
    filtered_df= spacex_df [spacex_df ['Launch Site'] == str(site_dropdown)]
    if site_dropdown == 'ALL':
        ...
        second_filtered_df = filtered_df.groupby(["class"]).count()
        pie = px.pie(second_filtered_df, values="Launch Site", 
